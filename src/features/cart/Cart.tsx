import { useCurrencyRate, useProducts } from '@shared/hooks'
import { CartItem } from '@shared/ui/Cart'

type CartItem = { count: number; id: number; name: string; price: number }
    ...
    <div className="w-2/6 h-max bg-white p-4 rounded">
      ...
      {isCartEmpty && (
        <div className="flex justify-center items-center">
          <span className="text-black">Корзина пуста Техлид!</span>
        </div>
      )}
    </div>
  )
